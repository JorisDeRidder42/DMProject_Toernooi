...
(
	...
	CONSTRAINT FK3_Prijs_Speler FOREIGN KEY (prijsId) REFERENCES ToernooiInschrijven.Speler(spelerId) ON DELETE CASCADE
); 
GO
...
INSERT INTO ToernooiInschrijven.Speler(voorNaam, achterNaam, nickNaam, wachtWoord, email, geboorteDatum, geboortePlaats)
	VALUES ('Joris','DeRidder', 'Jeuris42','****************', 'joris.42@hotmail.com','1997-02-21', 'Wilrijk'),
	('Dennis','Luyten', 'Kiiro','******', 'DennisLuten@outlook.be','1999-05-12', 'Lier'),
	('Jan','Ghesquire', 'Por0','********', 'JanGhesquire@telenet.com','1996-03-18', 'Herentals'),
	('Alec','VanOosterwijck', 'Tankzwaluw','******', 'DenAlec@outlook.be','2000-02-04', 'Lier'),
	('Jelle','Vermeulen', 'JayEnvy','********', 'JayEnvy@hotmail.be','1994-07-12', 'Antwerpen');
